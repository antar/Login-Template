<?php
	...
	function uidExists($conn, $username, $email) {
		...
		if (!mysqli_stmt_prepare($stmt, $sql)) {
			header("location: /JiraTicketSystem/signup.php?error=stmtfailed");
			exit();
		}
	...
	function createUser($conn, $username, $name, $email, $pwd) {
		...
		mysqli_stmt_execute($stmt);
		mysqli_stmt_close($stmt);		
		header("location: /JiraTicketSystem/signup.php?error=none");
		exit();
	}
	...
	function loginUser($conn, $username, $pwd) {
		...
		if ($uidExists === false) {
			header("location: /JiraTicketSystem/login.php?error=wronglogin");
			exit();
		}
